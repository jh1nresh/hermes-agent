...
_nous_free_tier_cache: Optional[bool] = None
...
def check_nous_free_tier() -> bool:
    ...
    Result is cached for the lifetime of the process so repeated calls
    (model selection, auxiliary client init) don't hit the portal API
    again.
    """
    global _nous_free_tier_cache
    if _nous_free_tier_cache is not None:
        return _nous_free_tier_cache
    ...
    try:
        ...
        _nous_free_tier_cache = is_nous_free_tier(account_info)
        return _nous_free_tier_cache
    except Exception:
        _nous_free_tier_cache = False
