...
AUTHOR_MAP = {
    ...
    "28944679+AnnasMazhar@users.noreply.github.com": "AnnasMazhar",  # PR #34586 evolution (#22722 Tirith-safe Git credential parsing)
    "13835061+bryanneva@users.noreply.github.com": "bryanneva",  # Issue #22722 reporter (Tirith false positive in bundled GitHub auth flow)
