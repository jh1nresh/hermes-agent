---
title: "Sonos — Control Sonos speakers: playback, volume, grouping"
sidebar_label: "Sonos"
...
Control Sonos speakers: playback, volume, grouping.
...
| Path | `skills/smart-home/sonos` |
| Version | `0.1.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Sonos`, `Smart-Home`, `Audio` |
| Related skills | [`openhue`](/docs/user-guide/skills/bundled/smart-home/smart-home-openhue) |
