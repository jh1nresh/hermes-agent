---
title: "Weather — Current weather and forecasts via Open-Meteo, no API key"
...
Current weather and forecasts via Open-Meteo, no API key.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/weather` |
| Path | `optional-skills/productivity/weather` |
| Version | `0.1.0` |
| Author | Hermes Agent |
| License | MIT |
